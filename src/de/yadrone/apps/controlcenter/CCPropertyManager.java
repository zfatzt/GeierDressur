...
public class CCPropertyManager extends Properties {
	...
	public Dimension getPluginScreenSize(String title) {
		...
		return new Dimension(Integer.parseInt(size.substring(0, size.indexOf("x"))),
				Integer.parseInt(size.substring(size.indexOf("x") + 1)));
	}
	...
	public Point getPluginScreenLocation(String title) {
		...
		return new Point(Integer.parseInt(location.substring(0, location.indexOf(","))),
				Integer.parseInt(location.substring(location.indexOf(",") + 1)));
	}
