...
public class ConnectionState extends JPanel implements ICCPlugin {
	...
	public ConnectionState() {
		...
		greenIcon = new Image(this.getClass().getResourceAsStream("/de/yadrone/apps/controlcenter/img/dot_green.png"));
		redIcon = new Image(this.getClass().getResourceAsStream("/de/yadrone/apps/controlcenter/img/dot_red.png"));
